<?php
    ...
    spl_autoload_register(function($clase){
        ...
        if(file_exists($archivo)){
            ...
            //El primer parámetro, "//" repetimos el caracter para que lo pueda tratar ya que
            //Esta es la razón por la cual el archivo y las clases siempre han de llevar el mismo
        }
    });
