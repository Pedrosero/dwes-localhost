  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    foreach ($matriz_personas as $persona): ?>
      ...
      <tr>
        ...
        <td class="bot"><a href="model/borrar.php?id=<?php echo $persona["id"] ?>"><input type='button' name='del' id='del'
              value='Borrar'></a></td>

        <!-- Añadimos los atributos necesarios para actualizar enviandolos por la url -->
        <td class='bot'><a
            href="model/editar.php?id=<?php echo $persona["id"] ?> & nom=<?php echo $persona["nombre"] ?> & ape=<?php echo $persona["apellido"] ?> & dir=<?php echo $persona["direccion"] ?>"><input
      ...
      <tr>
        ...
        <td class="bot"><a href="model/insertar.php?nom=$Nom & ape=$Ape & dir=$Dir"><input type='button' name='ins' id='ins'
              value='Insertar'></a></td> 
      </tr>
