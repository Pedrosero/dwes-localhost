...
<body>
    ...
    */
    ...
    //7 Con la función mysqli_query y pasándole como argumentos la conexión y la consulta, generamos una tabla virtual
    // en memoria (recordset o resultset) con todos los campos y registros.
    $results = mysqli_query($connection, $query);
    
     //8 Para mostrar todas las filas, podemos utilizar un blucle while y mientras exista otra
     // fila seguirá mostrando más filas de la tabla.
    //Usamos una tabla para enmarcar el contenido
    //NOTA: Utilizamos mysqli_fetch_array y MYSQLI_ASSOC para que la fila que nos devuelva sea un array asocitivo en
    //lugar de uno indexado y así poder accder a los campos por su nombre de la columna de una manera más intuitiva.
