...
<?php
/*
    Información: PHP/MySql. PHP/MySql. Insertando registros en BBDD MySql. Vídeo 42
    Enlace a video 42 PHP Mysql: https://www.youtube.com/watch?v=gaJjBm-T7SE
    Finalidad ejercicio: Mostrar en la Misma página
    Alumno: 

FALTACOMPLETAR:    FUNCIONES/ELEMENTOS QUE FALTAN POR COMPLETAR EN EL CÓDIGO:  
42_insertar_registros.php
enviar
*/
?>
<head>
    ...
    <title>42 Formulario de registro de datos</title>
    <style>
    h1 {
        text-align: center;
        color: #00F;
...
<body>
    ...
    <form name="form1" method="get" action="42_insertar_registros.php">
