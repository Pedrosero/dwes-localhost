...
<body>
   ...
   <?php
    ...
    while ($row = mysqli_fetch_array($results, MYSQLI_ASSOC)) {
        ...
        echo "<form action='46_3_actualizar.php' method='get'>";
        //NOTA. el campo código no debería ser editable, le añadimos readonly.
        echo "<input readonly type='text' name='c_art' value='". $row['codigoarticulo'] ."'><br>";//No se puede modificar
        echo "<input type='text' name='s_art' value='". $row['seccion'] ."'><br>";//Se puede modificar
        echo "<input type='text' name='n_art' value='". $row['nombrearticulo'] ."'><br>";
        echo "<input type='text' name='p_art' value='". $row['precio'] ."'><br>";
