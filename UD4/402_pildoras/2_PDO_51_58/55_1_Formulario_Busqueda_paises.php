...
<body>
    ...
    <form action="https://educacionadistancia.juntadeandalucia.es/centros/cordoba/pluginfile.php/462284/mod_folder/content/0/2_PDO_51_58/02-11-2023/55_2_conexion_pdo.php" method="post">
        <table>
            <tr>
                <td> seccion: </td>
